...
const [editContact,seteditContact]=useState(false);
  ...
  const [registrationNo, setRegistrationNo] = useState('TR00529');
      ...
      <div style={{ backgroundColor: 'var(--tershary-color)', paddingBottom: '200px', position: 'relative' }}>
        ...
        <div className='profile-contact-info' >
          <div className='tprofile-all'>
            ...
            <div className='Tprofile_form-contactinfo-btns'>
              <button style={{ margin: '10px' }} className='btn1'onClick={handleContactEdit} >Edit</button>
