...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const getcomapnyinfo = () => {
      ...
      fetch("https://textileapp.microtechsolutions.co.in/php/getbyid.php?Table=LoomTraderDetail&Colname=Id&Colvalue=" + user.Id, requestOptions)
    ...
    const getcontactinfo = () => {
      ...
      fetch("https://textileapp.microtechsolutions.co.in/php/getbyid.php?Table=ContactDetail&Colname=LoomTraderDetailId&Colvalue=529", requestOptions)
        .then((response) => response.json())
        .then((result) => {
          console.log('contactttt info:', result)
     
          if (result.length > 0) {
            const owner = result.find(contact => contact.Designation === 'Owner');
            const manager = result.find(contact => contact.Designation === 'Manager');
            const other = result.find(contact => contact.Designation === 'Other');
    ...
    <div className='loom-profile-all'>
      <div style={{ backgroundColor: 'var(  --tershary-color)', paddingBottom: '200px', position: 'relative' }}>
        <div className='Lprofile-company-info' >
          ...
          <div style={{ margin: '30px', boxShadow: '0px 0px 10px 0px rgba(0,0,0,0.5)', background: '#fff', marginRight: '7%' }}>
            ...
            <div className='profile-loom-compamyinfo-form'>
              ...
              <div className=' profile-loom-compamyinfo-form-btns' style={{ margin: '3.5% 0' }}>
                <button style={{ width: '30%', margin: '10px' }} className='btn1' onClick={handleEdit}>Edit</button>
                {editable && <button style={{ width: '30%', margin: '10px' }} className='btn2' onClick={handleSave}>Save</button>}
              </div>
            </div>
          </div>
          <div style={{ display: 'flex', margin: '30px', padding: '3% 0', boxShadow: '0px 0px 10px 0px rgba(0,0,0,0.5)', background: '#fff', marginRight: '7%' }}>
            ...
            <div style={{ marginTop: '10px', width: '22%', marginRight: '3%' }}>
              <label style={{ fontWeight: 'bold', margin: "10px", color: 'var(--primary-color)' }}>Registration No.</label>
              <input
        ...
        <div className='Lprofile-contact-info' >
          <div style={{ margin: '30px', boxShadow: '0px 0px 10px 0px rgba(0,0,0,0.5)', background: '#fff',  }}>  
            ...
            <div style={{ padding: "5px" }} className='profile-loom-contact-form'>
              ...
              <div style={{ display: 'flex', alignItems: 'center', margin:'3.5px 0' }} className='profile-loom-contact-form-btns'>
                <button style={{ width: '20%', margin: '10px' }} className='btn1' onClick={handleContactEdit}>Edit</button>
                {editContact && <button style={{ width: '20%', margin: '10px' }} className='btn2' onClick={handleContactSave}>Save</button>}
              </div>
            </div>
          </div>
