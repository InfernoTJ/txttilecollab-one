...
function CompletedOrder() {
  ...
  return (
    <>
      ...
      {completedorder.length === 0 && knottingcompletedorder.length === 0 && (
        <div>
          <div
            style={{
              display: "flex",
            ...
            {knottingcompletedorder.map((knottingcompleted) => (
              ...
              >
                <div>
                  ...
                  >
                    <p>OR: {knottingcompleted.OfferNo}</p>
                  </div>
                  <div
                    style={{
                      color: "var(--secondary-color)",
                  ...
                  >
                    <p>Party: {knottingcompleted.Name}</p>
                  </div>
                  <div
                    style={{
                      color: "var(--secondary-color)",
                  ...
                  >
                    <p>Reed: {knottingcompleted.Reed}</p>
                    <p>ReedSpace: {knottingcompleted.ReedSpace}</p>
                  </div>
                </div>
              </div>
            ))}
