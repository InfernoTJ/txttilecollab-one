 ...
 useEffect(() => {
  ...
  return (
    <div>
     ...
     {userinfo && <div  className="profileUser-card">
  ...
  <div className="aligndataicons">
              ...
              >
                {nouser} 
              </p><FaUsers className="homeicons"  style={{ color:'#ff9363' }}/></div>
            </div>
            ...
            <div className="profilecards">
              ...
              >
                {loomownerc}
              </p><SiLoom className="homeicons" style={{ color:'#08c27f' }}/>
            </div> </div>
            ...
            <div className="profilecards">
              ...
              >
                {tradercount}
              </p><GiRolledCloth className="homeicons" style={{ color:'#fb606e' }}/>
            </div></div>
            ...
            <div className="profilecards">
              ...
              >
                {totalenquires}
              </p><BsFillCollectionFill className="homeicons"  style={{ color:'#0facb0' }}/>
            </div></div>
          </div>
    </div>
  );
