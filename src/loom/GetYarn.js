...
function GetYarn() {
  ...
  const sendbroadcast = () => {
    ...
    broadcastmsgform.append("LoomId", user.Id);
    broadcastmsgform.append("TraderId", '');
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h3>{broadcast.TraderOrLoomName} - {broadcast.Sender==='L'?'Loom':broadcast.Sender==='T'?'Trader':'Yarn'}</h3>
